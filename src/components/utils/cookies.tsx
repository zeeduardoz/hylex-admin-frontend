...
export function Cookies() {
  ...
  return useCookies ? (
    ...
    <div className="bg-primary border-hr-color rounded-md border shadow-2xl bottom-0 right-0 mb-4 mr-4 max-w-sm px-5 py-7 fixed duration-200 transition-all ease-in-out">
